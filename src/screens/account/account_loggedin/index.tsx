...
import {UserModelExtended, SessionModel} from 'ucshared';
...
export class LoggedInAccount extends React.Component<NaviPageProps, { dataSource: ListViewDataSource, user: any }> {
	...
	logout() {
		store.save('profile_session', null)
			...
			.then((session) => this.props.app.setCurrentUser(session as SessionModel, () => this.props.app.navigateToRoute(RouteMap.Guide)));
	}
