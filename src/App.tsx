	...
	renderScene(route, navigator) {
		switch (route.id) {
			...
			case RouteMap.Guide.id:
				return <Guide guideApp={this} disableDrawer={this.disableDrawer.bind(this)}/>;

			case RouteMap.PaymentDetail.id:
				return <PaymentDetailPage navigator={navigator} app={this}/>;
			...
			case RouteMap.FAQ.id:
				return <FAQ app={this} navigator={navigator} />;
			...
			case RouteMap.PickerView.id:
				return <PickerView
					...
					selectItem={this.state.selectedAddress}
					app={this}
